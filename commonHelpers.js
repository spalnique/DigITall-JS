import{f as c,i as E,a as x,b as M,e as i,r as l,c as s,d as k,g as h,h as B,j as $,s as A,k as T}from"./assets/showHideFn-6188976b.js";import{b as _}from"./assets/vendor-389f7b34.js";function f(t,e){const a=JSON.parse(localStorage.getItem("cart"))?JSON.parse(localStorage.getItem("cart")):[];if(t.target.textContent.toLowerCase().includes("add"))a.push(e),localStorage.setItem("cart",JSON.stringify(a));else{const o=a.findIndex(n=>n._id===e._id);a.splice(o,1),localStorage.setItem("cart",JSON.stringify(a))}}function y(t){const e=I();return e?e.some(a=>a._id===t._id):!1}function I(){return JSON.parse(localStorage.getItem("cart"))||[]}const d="Add to shopping list",u="Remove from the shopping list",v='Congratulations! You have added the book to the shopping list. To delete, press the button "Remove from the shopping list".',C="",D="No description has been added to this book";let m;async function W(t){const e=t.target.dataset.id,a=await c(e);return m=a,`<div class="modal-container">
